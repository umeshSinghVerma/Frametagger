...
const StartingScreen = ({notYoutube}) => {
    return (
        <div className='start-screen flex items-center justify-center flex-col'>
            <a target='_blank' href='https://Youtube-Notes.com' className='flex flex-col items-center justify-center gap-2 border-b pb-2 border-[#80808056]'>
                <img src="/logo192.png" alt="" width={40} />
                <p style={{ fontFamily: "Oswald" }} className='text-xl'>Youtube-Notes</p>
            </a>
